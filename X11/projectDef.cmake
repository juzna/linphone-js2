...
SET(DEPS_MEDIASTREAMER "libasound2 (>> 1.0.22), libavcodec52 (>= 4:0.5+svn20090706-3) | libavcodec-extra-52 (>= 4:0.5+svn20090706-3), libgsm1 (>= 1.0.13), libogg0 (>= 1.0rc3), libsdl1.2debian (>= 1.2.10-1), libspeexdsp1 (>= 1.2~beta3.2-1), libswscale0 (>= 4:0.5+svn20090706-3) | libswscale-extra-0 (>= 4:0.5+svn20090706-3), libtheora0 (>= 0.0.0.alpha7.dfsg), libx11-6")
SET(DEPS_CORE "libspeex1, libosip2-4, libexosip2-4, libortp8")
SET(CPACK_DEBIAN_PACKAGE_DEPENDS "${DEPS_MEDIASTREAMER},${DEPS_CORE}")
SET(CPACK_DEBIAN_PACKAGE_CONFLICTS "libmediastreamer-dev")
